              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  ...
                  return ListView.separated(
                    separatorBuilder: (context, index) => SizedBox(height: getProportionateScreenHeight(context, 20),),
...
class OrderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(top: getProportionateScreenHeight(context, 15),left: getProportionateScreenWidth(context, 15),right: getProportionateScreenWidth(context, 15)),
                  ...
                  Expanded(
                    child: Row(
                      children: [
                        ...
                        Text('\$${cart.price}',style: TextStyle(color:kPrimaryColor ),)
                      ],
                    ),
                  ),
                  Text(
